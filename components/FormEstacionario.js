    ...
    <Container style={styles.container}>
      <Content style={styles.content}>
        ...
        <Form style={styles.form}>
          <ListItem>
            <CheckBox checked={isLleno} color="green" onPress={() => {setLleno(!isLleno); setLitros('')}} />
            <Body>
              <Text>Llenado de tanque</Text>
            </Body>
          </ListItem>
          {
            isLleno ? <Text style={{color: 'red'}}>Activar la opción de Lleno significa que el precio de llenado depende de lo requerido y el precio se establecerá hecho el servicio</Text>: (
              <>
                <Item floatingLabel>
                ...
                <Text style={styles.costo}>Precio: ${litros * COSTO_X_LITRO}</Text>
              </>
            )
          }
          <Button warning
