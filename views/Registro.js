            ...
            <View style={styles.formArea}>
              ...
              <Form style={styles.mainForm}>
                ...
                <Controller
                  ...
                  name="apellidos"
                  rules={{ required: {value: true, message: 'Los apellidos son requeridos'},
                ...
                <Controller
                  ...
                  defaultValue=""
                />
                {errors.repassword && <Text style={styles.textError}>La confirmación es requerida</Text>}
                {pwdError !== '' && <Text style={styles.textError}>{pwdError}</Text>}

                <Button block style={styles.mainBtn}>
                  <Text style={styles.btnText} onPress={handleSubmit(onSubmit)}>Registrar</Text>
                </Button>
              </Form>
            </View>
          </View>
